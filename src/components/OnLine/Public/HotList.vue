<template>
  <div >
      <div class="hotlist" v-for="(list,index) in hotList" :key="list.id" 
        ...
        <div  class="button" >
            <el-button size="small"  style="color:#FF33CC;background-color:#67C23A;"  @click="dialogVisible8 = true">查看奖项</el-button>
    ...
    <el-dialog title="抽奖活动设置" :visible.sync="dialogVisible8" width="50%" :before-close="handleClose">
            ...
            <span slot="footer">
                  <el-button type="danger"  @click="dialogVisible8 = false">发布</el-button>
                  <el-button type="warning"  @click="dialogVisible8 = false">取消</el-button>
            </span>
            </div>
    </el-dialog>
 </div>
