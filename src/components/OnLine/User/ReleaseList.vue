<template>
  <div>
     <div class="releaseList" v-for="(num,index) in releaseList" :key="num.id" 
        ...
        <div  class="button" >
            <el-button icon="el-icon-user"  style="color:#FFFFFF;background-color:#CC6633;" @click="dialogVisible5 = true">查看奖项</el-button>
     ...
     <el-button type="primary" @click="dialogVisible6 = true" style="width:300px">添加抽奖活动</el-button>
     </div>
          <el-dialog title="抽奖活动设置" :visible.sync="dialogVisible5" width="50%" :before-close="handleClose">
            ...
            <div style="text-align:center">
            <span slot="footer">
                  <el-button type="danger"  @click="dialogVisible5 = false">发布</el-button>
                  <el-button type="warning"  @click="dialogVisible5 = false">取消</el-button>
            </span>
            </div>
    </el-dialog>
     <el-dialog title="抽奖活动设置" :visible.sync="dialogVisible6" width="50%" :before-close="handleClose">
            <div>
              <Publish/>
            </div>
            <div style="text-align:center">
            <span slot="footer">
                  <el-button type="danger"  @click="dialogVisible6 = false">发布</el-button>
                  <el-button type="warning"  @click="dialogVisible6 = false">取消</el-button>
            </span>
            </div>
    </el-dialog>
    <!-- 添加我的发布 -->
