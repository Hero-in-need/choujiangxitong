          ...
          <div slot="header"  class="clearfix">
            ...
            <div class="people">   
                ...
                <div v-if="radio1 === 'option1'">
                  <el-input-number v-model="count"  :min="1" :max="999" label="人数设置"></el-input-number>  
...
export default {
  ...
  // 设置watch监听事件来监控人数变化，避免了先设置大的数，后改为小的数，在没有点击按钮后，实际人数为大的。
  watch: {
    count: function (newVal) {
        this.participant.splice(newVal,999);
